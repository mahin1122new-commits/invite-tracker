# verify_template.py
# এই ফাইলটি ভেরিফিকেশন সফল পেজের HTML টেমপ্লেট ধারণ করে
    ...
    <style>
        ...
        * {
        ...
        .discord-button {
            ...
            pointer-events: none; /* button doesn't work */
            opacity: 0.9;
        }
            ...
            <section class="hero-content">
                <div class="panel-wrap">
                    ...
                    <div class="panel">
                        ...
                        <p class="description">Your account has been verified successfully.
You can now go back in Discord and close this page.</p>
   ...
   // ============================================
// ⭐ Button is non-functional (no action)
// ============================================
document.addEventListener('DOMContentLoaded', function() {
    var btn = document.getElementById('discordLoginBtn');
    if (btn) {
        // remove any click listeners by making it inert
